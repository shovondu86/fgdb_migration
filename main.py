...
# Set variables
#Input_FGDB_path=r"D:\Worspace_ArcGISPro\projects\Data_Migration_SG\script\InputPolygonGDB.gdb"
#Target_FGDB_path =r"D:\Worspace_ArcGISPro\projects\Data_Migration_SG\script\TargetPolygonGDB.gdb"
...
if arcpy.Exists(InputPolygonFC) and arcpy.Exists(TargetPolygonFC):
    ...
    arcpy.AddError("{0} is not found.".format(InputPolygonFC))
    arcpy.AddError("{0} is not found.".format(TargetPolygonFC))
